...
--}}
         ...
         {{--           <button type="button" class="btn header-item waves-effect"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img id="header-lang-img" src="{{asset('admin')}}/assets/images/download.png" alt="Header Language" height="22">
                    </button>--}}
                    <div class="dropdown-menu dropdown-menu-right">

                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="eng">
                            <img src="{{asset('admin')}}/assets/images/flags/us.jpg" alt="user-image" class="mr-1" height="32"> <span class="align-middle">English</span>
                        </a>
                        <!-- item-->
