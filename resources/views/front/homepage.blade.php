                       ...
                       <a href="" class="a">
                        ...
                        <div class="single_shipping single-1">
                            ...
                            <div class="shipping_content f1">
                                ...
                                <p>Avtomobilinizin qiymətində razılaşacaq, 1 saat ərzində <br> pulunuz hesabınızda.  <br><span class="read-more">Ətraflı</span></p>
                            </div>
                        </div>
                    ...
                    <a href="">
                        ...
                        <div class="single_shipping single-2">
                            ...
                            <div class="shipping_content f2">
                                ...
                                <p>36 aya qədər sərfəli kredit <br> və lizinq şərtlərimiz işinizi  rahatlaşdıracaq.  <br><span class="read-more">Ətraflı</span></p>
                   ...
                   <a href="">
                    ...
                    <div class="single_shipping single-3">
                        ...
                        <div class="shipping_content f3">
                            ...
                            <p>100 yoxlayıb, 1 alırıq, <br> inamınızı doğrulduruq.<br><span class="read-more">Ətraflı</span></p>
                   ...
                   <a href="">
                    ...
                    <div class="single_shipping single-4">
                        ...
                        <div class="shipping_content f4">
                            <h2>Barter</h2>
                            <p>Barter xidmətinizdədir. <br> Sizə zəhmətsiz alış təcrübəsini yaşadacağıq.<br> <span class="read-more">Ətraflı</span></p>
                     ...
                     <div class="row" >
                         <div class="col-3" >
                            <div class="price_filter_area">
                                <p class="form-control" style="padding-left:5px "  >Qiymət</p>
                         ...
                         <div class="col-4"  >
                            <div class="price_filter_area" >
                                <p class="form-control buraxilis" style="padding-left:5px "  >Buraxılış ili</p>
                         ...
                         <div class="col-4" >
                            <div class="price_filter_area" >
                                ...
                                <input type="number" class="form-control" style="padding-left:5px " placeholder="min.">
                               </div>
                         </div>
                         <div class="col-4"  >
                            <div class="price_filter_area" >

                                <input type="number" class="form-control" style="padding-left:5px " placeholder="max.">
                               </div>
                         </div>
                     </div>
             </div>
...
<section class="product_area mb-50 ">
        ...
        <style>
            .custom-flex>.custom_card{
                box-shadow: 0px 4.34109px 4.34109px rgba(0, 0, 0, 0.25);
    padding:5px;
                overflow:hidden;
                position: relative;
            }
        ...
        <div class="container">
            ...
            <div class="card custom_card" style="width: 260px; margin: 10px; height:313px;">
                <img src="{{asset('/front/autima/')}}/assets/img/auto-car/Ch10.jpg" class="card-img-top" alt="..." style="width: 100%; height:173px; object-fit: cover;">
                <div class="card-body">

                    <a href="{{route('carDetail')}}"> <h4> <span>Chevrolet</span>  <span>Cruze</span></h4> </a>
                  <p class="card-text">1.4 L/ 2016 il/ 180 000 km <br>
                    <span class="lab" style="color: rgba(196, 196, 196, 1); font-size:13.2px;display:inline-block;">Kreditdədir. <br> "100 Nöqtə Yoxlanışı"ndan keçib.</span></p>
